angular.module("bubliq").controller("AdminRulesCtrl", ['$scope', '$reactive', '$state', '$timeout', '$mdToast', '$document', 'froalaImages', 'TITLES',
  function ($scope, $reactive, $state, $timeout, $mdToast, $document, froalaImages, TITLES) {
    $state.title = `${TITLES.ADMIN_CTRL} » ${TITLES.ADMIN_RULES_CTRL}`;
    ...
    this.editRules = function () {
      Meteor.call('editPortalRules', this.rules.text);
